...
fetch('https://yiketianqi.com/api?unescape=1&version=v6&appid=66287867&appsecret=T5FTxPqh')
...
//控制台输出
console.clear();
const LSPAge = parseInt((new Date().getTime() - new Date("2022-9-01").getTime()) / 86400000);
